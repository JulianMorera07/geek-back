"""Caso de uso: obtener los últimos Anime agregados, deduplicados y
ordenados entre todos los providers registrados.
"""
...
class GetAggregatedLatest:
    ...
    async def execute(
        ...
        return await self._engine.get_latest(pagination, parsed_provider_ids)
